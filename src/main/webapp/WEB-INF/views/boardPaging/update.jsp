		...
		<main>
			...
			<h2>${menuDTO.menu_name} 게시글</h2>
				<table id = "table">
					<tr>
						<td>작성자 이름:</td>
						<td><input type = "text" id ="writer" name = "writer" value="${board.writer}" readonly></td>
						<td>제목:</td>
					...
					<tr>
						<td colspan = "4">
							...
							<a class = "btn btn-dark btn-sm" href = "/BoardPaging/Blist?nowpage=${nowpage}&menu_id=${board.menu_id}">목록</a> &nbsp;&nbsp;
							<a class ="btn btn-dark btn-sm" href="/">메인</a>
						</td>
					</tr>
				</table>
			</form>
